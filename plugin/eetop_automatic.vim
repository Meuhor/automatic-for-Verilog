...
command SearchInstance1   :call SearchInstance(1)
command SearchInstance0   :call SearchInstance(0)
command SearchModule1     :call SearchModule(1)
command SearchModule0     :call SearchModule(0)
command SearchDriverLite  :call SearchDriverLite(0)
command BackwardMark      :call BackwardMark()
command ForwardMark       :call ForwardMark()

command RtlTree                   :call RtlTree()
command ShowInst                  :call ShowInst()
command ShowCall                  :call ShowCall()
command ShowDef                   :call ShowDef()
command AutoArg                   :call AutoArg()
command AutoDef                   :call AutoDef()
command AutoInst                  :call AutoInst(0)
command AppendPortDriectionToInst :call AppendPortDriectionToInst()
command Invert                    :call Invert()
command AutoComment               :call AutoComment()
command AutoComment2              :call AutoComment2()
command AddCurLineComment         :call AddCurLineComment()
command WireDef2PortConn          :call WireDef2PortConn()
command Input2Output              :call Input2Output()
command SearchUpInstLine          :call SearchUpInstLine()
...
function AutoInstUpdateOrder() "{{{2
    "======================================================================================
    "Function:
...
function AppendPortDriectionToInst() "{{{2
    "======================================================================================
    "Function:
